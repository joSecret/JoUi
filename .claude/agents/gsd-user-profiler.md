...
<reference>
@/Users/josecret/Astro/joui/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/josecret/Astro/joui/.claude/get-shit-done/references/user-profiling.md` to load:
