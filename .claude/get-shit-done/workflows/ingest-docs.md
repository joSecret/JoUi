...
```bash
INIT=$(node "/Users/josecret/Astro/joui/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/josecret/Astro/joui/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
