...
```
Agent(
  prompt="Read /Users/josecret/Astro/joui/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/josecret/Astro/joui/.claude/get-shit-done/templates/SECURITY.md`
