...
```bash
INIT=$(node "/Users/josecret/Astro/joui/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/josecret/Astro/joui/.claude/get-shit-done/templates/spec.md.
