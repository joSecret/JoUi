...
```markdown
Read /Users/josecret/Astro/joui/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/josecret/Astro/joui/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/josecret/Astro/joui/.claude/agents/gsd-ui-checker.md for instructions.
