...
```
Agent(
  prompt="Read /Users/josecret/Astro/joui/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/josecret/Astro/joui/.claude/get-shit-done/templates/VALIDATION.md`
